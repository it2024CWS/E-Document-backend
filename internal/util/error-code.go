...
const (
	...
	PASSWORD_MISMATCH    ErrorCode = "PASSWORD_MISMATCH"

	//NOTE - Role errors
	ROLE_NOT_FOUND      ErrorCode = "ROLE_NOT_FOUND"
	ROLE_ALREADY_EXISTS ErrorCode = "ROLE_ALREADY_EXISTS"

	//NOTE - Document flow errors
	ROUTE_ADVANCER_NOT_CONFIGURED ErrorCode = "ROUTE_ADVANCER_NOT_CONFIGURED"
	STEP_CREATOR_NOT_CONFIGURED   ErrorCode = "STEP_CREATOR_NOT_CONFIGURED"
	INCOMING_DOC_CREATE_FAILED    ErrorCode = "INCOMING_DOC_CREATE_FAILED"
	ROUTE_ATTACH_FAILED           ErrorCode = "ROUTE_ATTACH_FAILED"

	//NOTE - Upload / document errors
	INVALID_FILE_PATH       ErrorCode = "INVALID_FILE_PATH"
	DOC_NO_REQUIRED         ErrorCode = "DOC_NO_REQUIRED"
	DOC_NO_ALREADY_EXISTS   ErrorCode = "DOC_NO_ALREADY_EXISTS"
	TRANSACTION_BEGIN_FAILED  ErrorCode = "TRANSACTION_BEGIN_FAILED"
	TRANSACTION_COMMIT_FAILED ErrorCode = "TRANSACTION_COMMIT_FAILED"
)
